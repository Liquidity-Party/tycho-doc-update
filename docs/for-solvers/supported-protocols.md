...
<tr><td><code>lunarbase</code></td><td>Native (<code>LunarBaseTychoState</code>)</td><td>7 μs (0.007 ms)</td><td>Base</td><td></td></tr>
    ...
    match chain {
        ...
        Chain::Base => {
            builder = builder
                ...
                .exchange::<LunarBaseTychoState>("lunarbase", tvl_filter.clone(), None)
        }
        Chain::Unichain => {
            builder = builder
                .exchange::<UniswapV2State>("uniswap_v2", tvl_filter.clone(), None)
